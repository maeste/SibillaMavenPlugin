...
/**
 * The source inclusion scanner for TestedBy rules. Also provides a method for
...
public abstract class TestedBySourceScanner extends AbstractSourceInclusionScanner {
	...
	for (int i = 0; i < potentialIncludes.length; i++) {
		...
		for (File targetFile : targetFiles) {
		    //check the target binary files exist, otherwise the testedby plugin can't run tests
