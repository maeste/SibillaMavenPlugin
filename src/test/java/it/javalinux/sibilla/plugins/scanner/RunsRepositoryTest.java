...
public class RunsRepositoryTest {
    ...
    {
	File file = File.createTempFile("Sibilla-maven-plugin-test-run-repository-", String.valueOf(System.currentTimeMillis()) + ".bin");
    ...
    {
	File dir = File.createTempFile("Sibilla-maven-plugin-test-run-repository-", String.valueOf(System.currentTimeMillis()));
	dir.delete();
	dir.mkdir();
