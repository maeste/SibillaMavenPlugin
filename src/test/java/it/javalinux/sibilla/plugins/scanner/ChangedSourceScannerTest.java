...
import it.javalinux.sibilla.plugins.scanner.ChangedSourceScanner;
...
public class ChangedSourceScannerTest {
    ...
    {
	File dir = File.createTempFile("Sibilla-maven-plugin-test-changedsourcescanner-", String.valueOf(System.currentTimeMillis()));
	dir.delete();
	dir.mkdir();
	return dir;
    }
