...
import it.javalinux.sibilla.plugins.scanner.NewSourceScanner;
...
public class NewSourceScannerTest {
    ...
    {
	File dir = File.createTempFile("Sibilla-maven-plugin-test-newsourcescanner-", String.valueOf(System.currentTimeMillis()));
	dir.delete();
	dir.mkdir();
	return dir;
    }
